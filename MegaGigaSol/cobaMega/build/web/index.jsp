...
-->
    ...
    <li><a href="Beli.jsp"><img src="penjualan.png" height="80px" border="0"></a>
         <li><a href="jual.jsp"><img src="pembelian.png" height="80px" border="0"></a>
        ...
        <div id="con">
            ...
            <table border="1" cellspacing="0" cellpadding="0" width="50%">
                ...
                <tr >
                    ...
                    <td><a href="update.jsp?u=<%=rs.getString("KodeBarang")%>" >edit</a> / <a href="delete.jsp?d=<%=rs.getString("KodeBarang")%>" > hapus</a></td>
                </tr>
                <%   }    %>
            </table>
